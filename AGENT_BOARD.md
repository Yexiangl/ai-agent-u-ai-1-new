...
| TASK-042 | 进行中 | P1 | AI 助手页视觉升级与全局高级感优化 | 父任务：macOS/iOS 风格升级，先 AI 助手页再推广。 |
...
| TASK-042H | 待规划 | P1 | 视觉升级回归测试 | AI 助手页 B-F 回归，建议推广前先做。 |
...
| TASK-043E | 待规划 | P1 | 关于/教程低风险优化 | 关于 SettingGroup 试点，修复"OpenClaw Agent"。 |
| TASK-043F | 待规划 | P2 | 能力中心顶部视觉升级 | 仅 Hero+已安装区，保留排行卡片。 |
| TASK-043G | 待规划 | P2 | 文件库/摸鱼/对话轻量对齐 + 全局回归 | 仅视觉对齐。 |
