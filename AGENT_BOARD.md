...
| TASK-032D | ✅ 待验收 | P2 | 模型名去内部化 | `formatDisplayModel` 增强：openclaw/default→默认模型、hermes-agent→AI 助手。消息 footer/用量概览/ChatPage top bar 均通过 formatter 显示。不放内部路由 ID 到普通 UI。 |
