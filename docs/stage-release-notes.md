...
## v0.3.0 内部测试版（2026-05-29）

详细说明见 `docs/v0.3.0-internal-test-release.md`。

### 核心变化
- 一键启用 AI 助手（粘贴密钥 → 自动配置+启动+检查）
- 能力中心安装体验闭环（排行/信息/确认/loading/卸载/已安装管理）
- 本地诊断面板 + 控制台入口 + 一键启动本地服务
- 真实 Token usage 统计 + 本地用量概览
- 助手记忆切换到 OpenClaw 工作区
- 全局 UI 动效与交互 polish
